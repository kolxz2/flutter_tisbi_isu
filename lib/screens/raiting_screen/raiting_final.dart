...
class RaitingListView extends StatefulWidget {
  @override
  _RaitingListViewState createState() => _RaitingListViewState();
}

class _RaitingListViewState extends State<RaitingListView> {
  bool _enabled = true;
